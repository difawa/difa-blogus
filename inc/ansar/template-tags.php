    ...
    function blogus_page_pagination() { 
        ...
        <div class="col-md-12 text-center d-md-flex justify-content-<?php if($blogus_pagination_remove == 'true') { echo 'between';} else { echo 'center';} ?>">
            ...
            the_posts_pagination( array(
                'prev_text'          => '<span class="screen-reader-text">Halaman sebelumnya</span><i class="fa fa-angle-'.$prev_text.'"></i>',
                'next_text'          => '<span class="screen-reader-text">Halaman berikutnya</span><i class="fa fa-angle-'.$next_text.'"></i>',
                'aria_label'         => 'navigasi',
                ) 
            );
