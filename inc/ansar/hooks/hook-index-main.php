    ...
    function blogus_single_author_box() { 
        ...
        <div class="bs-info-author-block py-4 px-3 mb-4 flex-column justify-content-center text-center">
            ...
            <div class="flex-grow-1">
              <h4 class="title"> <a href ="<?php echo esc_url(get_author_posts_url( get_the_author_meta( 'ID' ) ));?>"><?php the_author(); ?></a></h4>
...
if (!function_exists('blogus_single_related_box')) :
    function blogus_single_related_box() { 
        ...
        if($blogus_enable_related_post == true){ ?>
            <div class="py-4 px-3 mb-4 bs-card-box" id="pos-terkait">
